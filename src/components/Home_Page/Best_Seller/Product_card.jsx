...
const Product_card = () => {
    return (
        <div class="card bg-base-100 rounded border-2 hover:border-primary my-7">
            <figure>
            ...
            <div className="absolute top-0 right-0 bg-primary p-2">
                <svg className="w-5 text-white" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
