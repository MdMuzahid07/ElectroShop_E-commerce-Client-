                ...
                <table className="table w-full">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th>
                                ...
                                <button className="btn btn-primary rounded btn-xs block">Trucker Update</button>
                            </th>
                        </tr>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th></th>
                            <th></th>
                            <th><button onClick={handleCancelAll} className="btn btn-primary rounded"><svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                            </svg><span className="ml-2">Cancel All</span></button></th>
                        </tr>
                    </tfoot>
                </table>
            </div>
